        ...
        <div id="contenedor">
                ...
                <c:forEach var="producto" items="${productosListados}" varStatus="contador">
                    <div class="row panel panel-default">
                        <a data-toggle="collapse" data-parent="#accordion" href="#${contador.index}">
                            <h3 class="blue well">${producto.nombre}</h3>
                        </a>
                        <div id="${contador.index}" class="panel-collapse collapse">
            ...
            <div class="row">
                ...
                <form class="panel panel-default" method= "post" action='/tienda_e.jimenezgr/Administracion/InsertarProducto' enctype="multipart/form-data">
                    <a data-toggle="collapse" data-parent="#accordion" href="#agregarP">
                        <h3 class="blue well">Agregar nuevo producto</h3>
                    </a>
                    <div id="agregarP" class="panel-collapse collapse">
                        <div class="row well">
                            <span class="col-lg-2">
                                <b>Nombre:</b>
